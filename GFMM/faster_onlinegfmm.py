...
#    
    isPruning = False
    training_file = "C:\\Hyperbox-based-ML\\Dataset\\train_test\\dps\\page_blocks_dps_1.dat"
    testing_file = "C:\\Hyperbox-based-ML\\Dataset\\train_test\\dps\\page_blocks_dps_2.dat"
    gamma = 1
    teta = 0.6
    teta_min = 0.6
    isDraw = False
