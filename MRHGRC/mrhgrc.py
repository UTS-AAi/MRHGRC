...
class Multi_Resolution_Hierarchical_Granular_Res_Classifier(object):
...
if __name__ == '__main__': 
    ...
    for exe_time in range(1):
        ...
        classifier = Multi_Resolution_Hierarchical_Granular_Res_Classifier(teta = teta_list, gamma = gamma, simil_thres = simil_thres, oper = oper)
